...
//
//
//    //Blocked Nodes are just null LogicLayer.OldNode values in grid
//    static OldNode [][] grid = new OldNode[5][5];
//
//    static PriorityQueue<OldNode> open;
//
...
//    }
//
//    static void checkAndUpdateCost(OldNode current, OldNode t, int cost){
...
//    int[][] blocked = array containing inaccessible LogicLayer.OldNode coordinates
//    */
//
...
//
//        grid = new OldNode[x][y];
//        closed = new boolean[x][y];
//        open = new PriorityQueue<>((Object o1, Object o2) ->
//        {
//            OldNode c1 = (OldNode)o1;
//            OldNode c2 = (OldNode)o2;
...
//
//           /*
//             Set blocked Nodes. Simply set the LogicLayer.OldNode values to null
//             for blocked Nodes.
//           */
...
//            OldNode current = grid[endI][endJ];
//            int i=0;
//            OldNode[] nodesArray = new OldNode[30];
